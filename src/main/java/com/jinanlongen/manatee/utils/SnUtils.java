...
public class SnUtils {
	 ...
	 * 可以输入苏宁采购目录名称进行模糊查询，系统返回该商户操作权限下的采购目录名称均符合的所有采购目录信息。也可以不输入任何数据进行查询，系统返回商户操作权限下的所有采购目录信息。
	...
	/**
	 * 通过此接口可获取苏宁系统中地区、省、市、区的代码。 1、国家代码可通过接口“suning.custom.nation.query”获取；
	 * 2、此接口可获取地区、省、市、区的代码及对应的名称； 3、如需使用城市代码，可通过此接口获取。
	 * 
	 * @param code
	 * @return
	 */
